        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid invoice">
                <div class="row-fluid invoice-logo">
                    <div class="span6 invoice-logo-space"><img src="media/image/walmart.png" alt=""/></div>
                    <div class="span6">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span8 invoice-block">
                        ...
                        <br/>
                        <a class="btn blue big hidden-print" onclick="javascript:window.print();">Print <i
                                class="icon-print icon-big"></i></a>
                        <a class="btn green big hidden-print">Submit Your Invoice <i
