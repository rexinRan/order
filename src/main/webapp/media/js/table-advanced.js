var TableAdvanced = function () {
    ...
    var initTable1 = function () {
        ...
        function fnFormatDetails(oTable, nTr) {
            ...
            var sOut = '<table>';
            sOut += '<tr><td>金额:</td><td>' + aData[2] + '</td></tr>';
            sOut += '<tr><td>时间:</td><td>' + aData[3] + '</td></tr>';
            sOut += '<tr><td>合同状态:</td><td>' + aData[4] + '</td></tr>';
            sOut += '<tr><td>其他:</td><td>Could provide a link here</td></tr>';
            sOut += '</table>';
