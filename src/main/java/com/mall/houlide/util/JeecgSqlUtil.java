...
public class JeecgSqlUtil {
    ...
    private static String getFlieTxt(String fileUrl) {
        com.mall.houlide.util.LogUtil.info("---------------------------------------sql 路径 :" + fileUrl);
        String sql = null;
        try {
    ...
    public static String getMethodSqlLogic(String methodUrl) {
        ...
        com.mall.houlide.util.LogUtil.info(sqlurl);
...
//		String projectPath =  request.getSession().getServletContext().getRealPath("/");
    ...
    public static void main(String[] args) {
        ...
        com.mall.houlide.util.LogUtil.info(getCountSqlBySql("SELECT * 	from JEECG_DICT_PARAM WHERE 1=1"));
    }
