...
public class SendMailUtil {
    ...
    public static void sendFtlMail(String toMailAddr, String subject,
        ...
        try {
            ...
            com.mall.houlide.util.LogUtil.info(htmlText);
            hemail.setMsg(htmlText);
            hemail.send();
            com.mall.houlide.util.LogUtil.info("email send true!");
        } catch (Exception e) {
            e.printStackTrace();
            com.mall.houlide.util.LogUtil.info("email send error!");
        }
    }
    ...
    private static String getFilePath() {
        ...
        path = path.replace("\\", "/");
        com.mall.houlide.util.LogUtil.info(path);
        return path;
    }
    ...
    public static String getAppPath(Class cls) {
        ...
        com.mall.houlide.util.LogUtil.info("realPath----->" + realPath);
        return realPath;
    }
